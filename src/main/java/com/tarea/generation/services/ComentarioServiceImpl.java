...
public class ComentarioServiceImpl implements ComentarioService {
    ...
    public ResponseEntity<?> borrarComentarioPorId(Long id) {
        ...
        if (comentarioOptional.isPresent()) {
            ...
            return ResponseEntity.ok("El comentario ha sido borrado con exito");
        } else {
            return ResponseEntity.status(HttpStatus.NOT_FOUND).body("El comentario no ha sido encontrado. Id: " +id);
        }
    }
